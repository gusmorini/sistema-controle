            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <input id="txt-categoria" name="txt-categoria" class="form-control" placeholder="Digite o nome da categoria...">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <?php
                            ...
                            foreach($categorias as $categoria){
                                ...
                                $alterar = anchor(base_url('admin/categoria/editar/'.md5($categoria->id)),'<i class="fa fa-refresh fa-fw"></i> Alterar');
