            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <input type="text" id="txt-nome" name="txt-nome" class="form-control" placeholder="Digite o nome do usuário" value="<?= set_value('txt-nome')?>">
                        </div>                        
                        <div class="form-group">
                        <label id="txt-email">E-mail</label>
                        <input type="text" id="txt-email" name="txt-email" class="form-control" placeholder="Digite o email do usuário" value="<?= set_value('txt-email')?>">
                        </div>                        
                        <div class="form-group">
                        <label id="txt-historico">Histórico</label>
                        <textarea id="txt-historico" name="txt-historico" class="form-control"><?= set_value('txt-historico')?></textarea>
                        </div>
                        <div class="form-group">
                        <label id="txt-user">User</label>
                        <input type="text" id="txt-user" name="txt-user" class="form-control" placeholder="Digite o user do usuário" value="<?= set_value('txt-user')?>">
                        </div>  
                        <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <?php
                            ...
                            foreach($usuarios as $usuario){
                                $nomeuser = $usuario->nome.'<br><small>'.$usuario->user.'</small>';
                                
                                if($usuario->img == 1){ 
                                $img_prop = array(  'src'=>'assets/frontend/img/usuarios/'.md5($usuario->id).'.jpg',
                                                    'width'=>'60',
                                                    'height'=>'60');    
                                $fotouser = img($img_prop);
                                }else{
